...
export class BattleCamera {
    ...
    updateZoomAndPan(playerX: number, enemyX: number) {
        ...
        this.camera.centerOnX(Phaser.Math.Linear(this.camera.midPoint.x, midX, 0.1));
    ...
    flash(duration: number = 100, r: number = 255, g: number = 255, b: number = 255, force: boolean = false) {
