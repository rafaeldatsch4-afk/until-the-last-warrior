...
const special = extractAndRemoveMethod('private specialCleave(isP: boolean) {');
const superAtt = extractAndRemoveMethod('private specialMalevolentShrine(isP: boolean) {');

fs.writeFileSync('thukuna_methods_2.txt', [special, superAtt].join('\\n\\n=====\\n\\n'));
